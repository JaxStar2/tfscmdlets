...
namespace TfsCmdlets.Services.Impl
{
    ...
    internal class WorkItemServiceImpl : IWorkItemService
    {
        public WorkItem GetWorkItem(object workItem, object revision, object asof, string query, string filter, string text, Dictionary<string, object> macros, object project, object collection, object server, object credential)
        {
        ...
        public IEnumerable<WorkItem> GetWorkItems(object workItem, object revision, object asof, string query, string filter, string text, Dictionary<string, object> macros, object project, object collection, object server, object credential)
        {
            while (true)
            {
                switch (workItem)
        ...
        protected virtual IEnumerable<WorkItem> GetByWiql(string queryText, Dictionary<string, object> macros, object project, object collection, object server, object credential)
        {
            ...
            {
                var savedQuery = WorkItemQueryService.GetItem<QueryDefinition2>(queryText, WorkItemQueryScope.Both,
